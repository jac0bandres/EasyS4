...
from slicer.cura_config import get_config, get_slicer_settings
...
def s4_slice(model_path):
    ...
    deformed_tet.extract_surface().save(f'output_models/deformed/{model_name}_deformed_tet.stl')
    ...
    feed = 5000
    gcode_points = []
    with open(f'input_gcode/deformed/{model_name}_deformed_tet.gcode', 'r') as fh:
